...
class ZoomBreakoutAPI
  ...
  ZM_BREAKOUT_CLIENT_ID = ENV.fetch('ZM_BREAKOUT_CLIENT_ID')
  ZM_BREAKOUT_CLIENT_SECRET = ENV.fetch('ZM_BREAKOUT_CLIENT_SECRET')
  ZM_BREAKOUT_REDIRECT_URL = ENV.fetch('ZM_BREAKOUT_REDIRECT_URL')
